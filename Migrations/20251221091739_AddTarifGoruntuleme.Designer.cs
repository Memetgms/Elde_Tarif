...
namespace Elde_Tarif.Migrations
{
    ...
    [Migration("20251221091739_AddTarifGoruntuleme")]
    partial class AddTarifGoruntuleme
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elde_Tarif.Models.TarifGoruntuleme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnonId", "TarifId", "ViewedAt");

                    b.HasIndex("KullaniciId", "TarifId", "ViewedAt");

                    b.ToTable("TarifGoruntuleme", (string)null);
                });
            ...
            modelBuilder.Entity("Elde_Tarif.Models.TarifGoruntuleme", b =>
                {
                    b.HasOne("Elde_Tarif.Models.AppUser", "Kullanici")
                        .WithMany("TarifGoruntulemeler")
                        .HasForeignKey("KullaniciId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Elde_Tarif.Models.Tarif", "Tarif")
                        .WithMany("Goruntulemeler")
                        .HasForeignKey("TarifId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Elde_Tarif.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("TarifGoruntulemeler");
