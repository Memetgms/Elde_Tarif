        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SefId = table.Column<int>(type: "int", nullable: false),
                    ...
                    PorsiyonSayisi = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    KaloriKcal = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
                    ProteinGr = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
                    KarbonhidratGr = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
                    YagGr = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
