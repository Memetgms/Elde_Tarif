...
namespace Elde_Tarif.Models
{
    public class Tarif
    {
        ...
        // Diyagramdaki gibi decimal(6,2)
        public decimal? PorsiyonSayisi { get; set; }

        public decimal? KaloriKcal { get; set; }
        public decimal? ProteinGr { get; set; }
        public decimal? KarbonhidratGr { get; set; }
        public decimal? YagGr { get; set; }
